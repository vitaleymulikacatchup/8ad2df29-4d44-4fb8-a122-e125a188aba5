...
export const metadata: Metadata = {
  title: "Beli | Creative Design Agency",  description: "Beli is a full-service design agency creating transformative digital experiences. Strategic design solutions for brands that matter.",  keywords: ["design agency", "creative design", "brand design", "web design", "UI/UX design", "digital experience"],
  metadataBase: new URL("http://img.b2bpic.net"),
  alternates: {
    canonical: "http://img.b2bpic.net"
  },
  openGraph: {
    title: "Beli | Creative Design Agency",    description: "Creative design solutions that transform brands and engage audiences.",    siteName: "Beli",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/public-examination-preparation-concept_23-2149369872.jpg",        alt: "Beli Design Agency"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Beli | Creative Design Agency",    description: "Transform your brand with strategic design solutions.",    images: ["http://img.b2bpic.net/free-photo/public-examination-preparation-concept_23-2149369872.jpg"]
  },
  robots: {
    index: true,
    follow: true
